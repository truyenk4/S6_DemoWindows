...
namespace QuanLyBanVe
{
    public partial class MDIParent : Form
    {
        ...
        {
            HienThiDuyNhatFormCon<FrmMain>();
        }

        private void openToolStripButton_Click(object sender, EventArgs e)
        {
            HienThiDuyNhatFormCon<FrmThemKhuVuc>();
        }

        private void HienThiDuyNhatFormCon<T>()
        {
        ...
        private void openToolStripButton_CheckedChanged(object sender, EventArgs e)
        {
